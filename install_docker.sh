...
sudo echo "libssl1.1	libraries/restart-without-asking	boolean	false" | debconf-set-selections
sudo echo "libssl1.1:amd64	libraries/restart-without-asking	boolean	false" | debconf-set-selections
sudo echo "libssl1.0.0	libssl1.0.0/restart-services	string	" | debconf-set-selections
