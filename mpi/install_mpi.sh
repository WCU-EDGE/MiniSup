...
#cd mpich-3.3.2
#
#./configure --disable-fortran --prefix=/software/mpi --exec-prefix=/software/mpiexec --with-slurm=/software/slurm --with-slurm-include=/software/slurm/include --with-slurm-lib=/software/slurm/lib --with-pmi=pmi2 --with-pm=slurm
#
