...
sudo debconf-set-selections <<< 'slapd/root_password password rams'
sudo debconf-set-selections <<< 'slapd/root_password_again password rams'
sudo debconf-set-selections <<< 'slapd/generated_adminpw password rams'
sudo debconf-set-selections <<< 'slapd/adminpw password rams'
