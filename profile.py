...
pc.defineParameter( "pfscount", "Number of parallel file system nodes (1 or more). If you change this, also change pfs/pfs_servers.json to match!", portal.ParameterType.INTEGER, 5 )
